...
import 'piccolore';
import { H as HeadConfigSchema, b as urlToSlug, s as slugToLocaleData, c as getSidebarFromConfig, d as getSidebar, e as getSiteTitle$1, f as getToC, h as getSiteTitleHref, i as getPrevNextLinks, j as getHead, a as attachRouteDataAndRunMiddleware, $ as $$Page, k as context, l as getLoaderConfig, m as getLink, n as getPathWithLocale, o as getI18nLabel } from './middleware-BtzPJG0A.js';
import * as z from 'zod';
import { s as stripLeadingAndTrailingSlashes, g as getCollectionPathFromRoot, p as project, a as starlightConfig, b as getCollection, r as renderEntry } from './translations-DMOfUV_Y.js';
import { I as Icons, a as I18nBadgeConfigSchema, B as BadgeConfigSchema, p as parseAsyncWithFriendlyErrors, b as parseWithFriendlyErrors, $ as $$Badge, c as $$Icon, d as $$LinkButton } from './Code-DEsB8nI4.js';
/* empty css                        */
...
async function getUserDocsSchema() {
  const userCollections = (await import('./collection-config-u_YL1tlc.js')).collections;
