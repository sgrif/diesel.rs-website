...
If you look at the documentation for [`update`](https://docs.diesel.rs/2.0.x/diesel/fn.update.html),
...
[src/lib.rs](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L9-L18)
...
[src/lib.rs](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L30-L34)
...
[Generated SQL](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L36-L44)
...
[src/lib.rs](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L46-L54)
...
[Generated SQL](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L56-L70)
...
[the `Identifiable` trait]: https://docs.diesel.rs/2.0.x/diesel/associations/trait.Identifiable.html

If we wanted a struct that mapped to our posts table, it'd look something like this:

::: code-block

[src/lib.rs](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L20-L28)
...
[src/lib.rs](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L72-L76)
...
[Generated SQL](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L78-L93)
...
[src/lib.rs](https://github.com/diesel-rs/diesel/tree/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L95-L101)
...
[Generated SQL](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L103-L113)
...
[src/lib.rs](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L115-L124)
...
[Generated SQL](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L126-L139)
...
[`.set`]: https://docs.diesel.rs/2.0.x/diesel/query_builder/struct.UpdateStatement.html#method.set
[`AsChangeset`]: https://docs.diesel.rs/2.0.x/diesel/query_builder/trait.AsChangeset.html

::: code-block

[src/lib.rs](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L141-L143)
...
[Generated SQL](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L145-L176)
...
[src/lib.rs](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L178-L192)
...
[Generated SQL](https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs#L194-L213)
...
[upsert docs]: https://docs.diesel.rs/2.0.x/diesel/upsert/index.html
...
[`execute`]: https://docs.diesel.rs/2.0.x/diesel/query_dsl/trait.RunQueryDsl.html#tymethod.execute
...
[`get_result`]: https://docs.diesel.rs/2.0.x/diesel/query_dsl/trait.RunQueryDsl.html#method.get_result
[`get_results`]: https://docs.diesel.rs/2.0.x/diesel/query_dsl/trait.RunQueryDsl.html#method.get_results
[`returning`]: https://docs.diesel.rs/2.0.x/diesel/query_builder/update_statement/struct.UpdateStatement.html#method.returning
...
[`save_changes`]: https://docs.diesel.rs/2.0.x/diesel/query_dsl/trait.SaveChangesDsl.html#method.save_changes

All of the code for this guide can be found in executable form in [this Diesel example].

[this Diesel example]: https://github.com/diesel-rs/diesel/blob/2.0.x/examples/postgres/all_about_updates/src/lib.rs
