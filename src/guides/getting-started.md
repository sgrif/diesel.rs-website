...
[`#[derive(Queryable)]`]: https://docs.diesel.rs/2.3.x/diesel/prelude/derive.Queryable.html
[`#[derive(Selectable)]`]: https://docs.diesel.rs/2.3.x/diesel/prelude/derive.Selectable.html
...
::: sqlite-example
::: code-block
[src/lib.rs](https://github.com/diesel-rs/diesel/blob/2.3.x/examples/sqlite/getting_started_step_2/src/lib.rs)
```rust
use self::models::{NewPost, Post};
