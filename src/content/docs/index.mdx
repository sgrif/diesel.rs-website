  ...
  - tag: style
    content: |
      ...
      */
      ...
      /* MOBILE FIRST (default for smallest screens) */
      ...
      starlight-tabs .tab.astro-esqgolmp[data-selected] a.astro-esqgolmp {
      ...
      starlight-tabs .tab.astro-esqgolmp a.astro-esqgolmp[aria-selected="false"] {
        background: rgba(255, 255, 255, 0.05);
      }

      starlight-tabs .tab.astro-esqgolmp a.astro-esqgolmp[aria-selected="true"]:hover {
        color: #3e3e5b;
      }
